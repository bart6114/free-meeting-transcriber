...
## Stay Connected
- Follow updates on [X](https://example.com/x).
- Join the community and chat on [Discord](https://example.com/discord). 
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Acme: Enhanced Meeting Notes

# Objective: Introduce Acme as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Acme through X and Discord.
...
# Further Information: Follow updates on [X](https://example.com/x) and [Discord](https://example.com/discord).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://example.com/x) and [Discord](https://example.com/discord).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://example.com/x">X</a>.</li>
        <li>Join the community and chat on <a href="https://example.com/discord">Discord</a>.</li>
        </ul>
        "#);
    }

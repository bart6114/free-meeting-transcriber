...
- Chat controls now live inside the chat panel, with a clearer assistant label
- Folder controls have been removed so sessions remain the primary organization model
- App icon and installer artwork updated for the new brand
- In-app web links now point to the current website instead of older docs

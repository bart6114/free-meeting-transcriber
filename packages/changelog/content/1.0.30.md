...
- New stable installs now use a new data folder by default
- Existing legacy data folders and database paths are still preserved so current installs continue to open the same data

...
Version 1.0.1 brings significant improvements to plugin architecture, data management, and overall user experience.
...
- Add Templates import to the legacy importer (supports v0 stable and nightly)
...
- Fix path display and reveal behavior for legacy import sources

...
- Legacy local models are now labeled as deprecated, the legacy hosted provider card has been removed, and local model folder/delete controls live directly in the model picker
...
- Changelog pages are now available on the website, with cleaner release summaries

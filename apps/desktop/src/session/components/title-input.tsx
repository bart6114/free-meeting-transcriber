      ...
      return (
        <div
          ...
          className={cn([
            ...
            variant === "breadcrumb" ? "h-5" : "h-[1.75rem]",
          ])}
        >
          <span
            className={cn([
              ...
              variant === "breadcrumb"
                ? "text-sm leading-5"
                : "text-[1.375rem] leading-[1.75rem] font-[520] tracking-[-0.01em]",
            ])}
          >
        ...
        <div
          ...
          className={cn([
            ...
            variant === "breadcrumb"
              ...
              : "h-[1.75rem] text-[1.375rem] leading-[1.75rem] font-[520] tracking-[-0.01em]",
          ])}
        >
          <input
            data-tauri-drag-region="false"

    ...
    >
      <span
        ...
        className={cn([
          ...
          "group-hover/chat-cta:border-border/70 group-focus-visible/chat-cta:border-border/70 group-hover/chat-cta:bg-[#f4f4f5] group-focus-visible/chat-cta:bg-[#f4f4f5] dark:group-hover/chat-cta:bg-[#202020] dark:group-focus-visible/chat-cta:bg-[#202020]",
      ...
      >
        <span
          ...
          className={cn([
            ...
            "group-focus-within/chat-cta:text-muted-foreground group-hover/chat-cta:text-muted-foreground text-white/55",

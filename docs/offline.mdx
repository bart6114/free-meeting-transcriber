...
Free Meeting Transcriber can record meetings and manage notes without an internet connection. To transcribe, summarize, and chat offline, configure local models before you disconnect.
...
Remote API-key providers and Google and Outlook calendar sync need a network connection.

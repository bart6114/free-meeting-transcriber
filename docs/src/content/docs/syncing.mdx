...
Retained audio is usually the largest part of a synced vault. You can shorten or disable audio retention under **Settings → App → Meetings** without removing the notes or transcript. See [Audio retention](/data-and-privacy#audio-retention).

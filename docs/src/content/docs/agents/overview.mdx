...
```bash
loofah --json sessions new --title "Research: customer onboarding" --note findings.md --tag research --author claude-code
loofah --json sessions attach SESSION_ID onboarding-research.pdf
```

...
Agents should use the CLI or MCP server, not SQLite. Those interfaces apply Free Meeting Transcriber's rules for canonical notes, generated summaries, and transcript text.

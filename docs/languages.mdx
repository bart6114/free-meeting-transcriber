...
Free Meeting Transcriber separates the language used for summaries and chat from the languages it should expect in a conversation.

## Choose the main language

Open **Settings → App → Language & Region** and choose **Main language**.

Free Meeting Transcriber uses the main language for summaries, chat, and other AI-generated responses. It is also always included as a transcription language.

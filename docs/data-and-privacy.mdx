...
Use Free Meeting Transcriber's export tools when you need a portable copy. Do not edit the app database directly.

## When content is sent elsewhere

The destination depends on the feature you choose:

- A remote **Intelligence** provider receives the text and instructions needed to create a summary or chat response.
...
Your own API-key providers and local providers are separate choices. Review the provider's own retention and training policies before sending sensitive content.
